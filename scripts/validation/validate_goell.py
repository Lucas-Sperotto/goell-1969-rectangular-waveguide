...
from lib.solver_api import call_solver, ensure_solver_exists
from tracking.track_roots import filter_branches, load_points, track_branches, write_tracked_csv
...
ARTICLE_MODE_NOTES = {
    "fig16": [
        "`E^y_11, E^x_11`",
        "`E^y_12, E^x_12, E^y_21, E^x_21`",
        "`E^y_31, E^x_13`",
        "`E^x_31, E^y_13`",
        "`E^y_22, E^x_22`",
        "`E^y_32, E^x_23, E^y_23, E^x_32`",
    ],
    "fig17": [
        "`E^y_11, E^x_11`",
        "`E^y_21, E^x_21`",
    ...
    "fig18": [
        "`E^y_11, E^x_11`",
        "`E^x_12`, `E^y_21`, `E^y_12`, `E^x_21`",
        "`E^y_31, E^x_13`",
        "`E^y_13, E^x_31`",
        "`E^y_22, E^x_22`",
        "`E^x_32`, `E^y_23`, `E^y_32`, `E^x_23`",
    ],
    "fig19": [
        "`E^x_11`, `E^y_11`, `E^x_21`, `E^y_21`",
        "`E^y_31`, `E^x_31`, `E^x_12`, `E^y_12`",
        "`E^y_22`, `E^x_22`, `E^y_41`, `E^x_41`",
    ],
}
    ...
    *,
    ...
    if qualitative:
        ...
        for note in qualitative:
            lines.append(f"- {note}")
    article_modes = ARTICLE_MODE_NOTES.get(tag, [])
    if article_modes:
        lines.append("")
        lines.append("## Modos Indicados No Artigo")
        lines.append("")
        for note in article_modes:
            lines.append(f"- {note}")
    lines.append("")
